<template>
	<div class='cart'>
		<header>
			<i class='iconfont icon-fanhui' @click="$route.back()"></i>
			<span>购物车</span>
				...
				<li v-for='(item,index) in list' :key='index'>
					...
					<div class='goods'>
						<div class='goods-title'>
							...
							<i class='iconfont icon-del' @click="delGoodsFn"></i>
						</div>
		...
		<footer v-if="list.length">
			...
			<div class='order' v-if="isNavStatus" @click="delGoodsFn(item.id)">删除</div>
...
export default {
	...
	methods: {
		...mapMutations(['cartList', 'initOrder', 'checkItem']),
